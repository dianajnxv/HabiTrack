...
MEDIA_URL = '/media/'  # URL, за яким медіа-файли доступні
MEDIA_ROOT = os.path.join(BASE_DIR, 'media')  # Локальна директорія для збереження медіа-файлів
...
EMAIL_HOST_PASSWORD = 'ucur wlnz dpnu gkhh'
EMAIL_USE_TLS = True
